...
describe("buildWrites for an eval", () => {
  const payload = { gameId: "g1", ply: 7, version: 7, evalCp: -35, evalMate: null, bestReply: "Nf3", sacrifice: true, secondCp: -120, secondMate: null };
  ...
  it("streams the eval and caches it only for the newest ply", () => {
    ...
    expect(latest.stream).toMatchObject({ type: "EvalUpdated", ply: "7", version: "7", evalCp: "-35", evalMate: "", bestReply: "Nf3", sacrifice: "true", secondCp: "-120", secondMate: "" });
